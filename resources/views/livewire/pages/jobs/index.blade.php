                                ...
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center flex-wrap gap-2">
                                            <?php $job['skills'] = json_decode($job['skills'],true); ?>
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center flex-wrap gap-2">
                                                ...
                                                <span class="inline-block bg-amber-100 rounded-full px-2 py-0.5 text-xs font-medium text-amber-800">{{ $job['extra'] }}</span>
